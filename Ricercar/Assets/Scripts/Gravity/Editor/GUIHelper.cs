    ...
    public static class GUIHelper
    {
        ...
        static GUIHelper()
        {
            ...
            if (tyGUIClip != null)
            {
                ...
                var piTopMostRect = tyGUIClip.GetProperty("topmostRect", BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic);
                if (piTopMostRect != null)
                {
                    var getMethod = piTopMostRect.GetGetMethod(true) ?? piTopMostRect.GetGetMethod(false);
                    TopMostRect = (Func<Rect>)Delegate.CreateDelegate(typeof(Func<Rect>), getMethod);
                }

                var unclipMethodInfo = tyGUIClip.GetMethod(
                    "Unclip", 
                ...
                if (unclipMethodInfo != null)
                {
                    var method = Delegate.CreateDelegate(typeof(Func<Vector2, Vector2>), unclipMethodInfo);
                    Unclip = (Func<Vector2, Vector2>)method;
                }
            }
        ...
        public static Func<Rect> TopMostRect;
        public static Func<Vector2, Vector2> Unclip;
