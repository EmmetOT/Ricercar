...
{
    public static void BindUntilDisable<T, U>(this MonoBehaviour mono, string tag, OnEvent<T, U> onEvent)
    {
        GetOrAddComponent<T, U, UnibusDisableSubscriber>(mono, tag, onEvent);
    }
    ...
    public static void BindUntilDestroy<T, U>(this MonoBehaviour mono, string tag, OnEvent<T, U> onEvent)
    {
        GetOrAddComponent<T, U, UnibusDestroySubscriber>(mono, tag, onEvent);
    }
    ...
    private static void GetOrAddComponent<T, U, S>(MonoBehaviour mono, string tag, OnEvent<T, U> onEvent) where S : UnibusSubscriberBase
    {
